...
*/
//I: any value or datatype
//O: a string of the datatype
//use the Array.isArray to check if value is an array
//use typeof operator to see what data the given value is
...
*   _.first(["a", "b", "c"], 2) -> ["a", "b"]
*/
//I: an Array, number. first number of values in the given Array
//O: an Array of the first number of values
//E: if no number is given, return the last element in the Array
//if a negative number is given  return an empty array
//if the given number is greater than the array's length return the array
//if it is not an Array, return an empty array
_.first = function(array, number){
    //create an empty Array
    //call the typeOf function we created to see if the given array is an array 
    let newArr = [];
